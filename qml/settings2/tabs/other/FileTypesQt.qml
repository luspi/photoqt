...
EntryContainer {
		...
		EntrySetting {
			...
			GridView {
				...
				delegate: FileTypesTile {
					id: tile
					fileEnding: entry.types_qt[index][0]
					tooltip: entry.types_qt[index][1]
					...
					Component.onCompleted:
						entry.modeldata[entry.types_qt[index][1]] = tile.checked
					onCheckedChanged:
						entry.modeldata[entry.types_qt[index][1]] = tile.checked
				}
	...
	function saveData() {
		...
		// Update data
		fileformats.formatsQtEnabled = tobesaved
