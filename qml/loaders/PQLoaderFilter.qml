...
Loader {
    ...
    sourceComponent: ((PQCSettings.interfacePopoutFilter || PQCWindowGeometry.filterForcePopout || PQCSettings.generalInterfaceVariant==="integrated") ? comp_filter_popout : comp_filter)
