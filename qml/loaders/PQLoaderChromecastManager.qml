...
Loader {
    ...
    active: false
    anchors.fill: parent
    sourceComponent: ((PQCSettings.interfacePopoutChromecast || PQCWindowGeometry.chromecastmanagerForcePopout || PQCSettings.generalInterfaceVariant === "integrated") ? comp_chromecastmanager_popout : comp_chromecastmanager)
