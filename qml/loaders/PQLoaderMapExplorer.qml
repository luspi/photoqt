...
Loader {
    ...
    active: false
    anchors.fill: parent
    sourceComponent: ((PQCSettings.interfacePopoutMapExplorer || PQCWindowGeometry.mapexplorerForcePopout || PQCSettings.generalInterfaceVariant==="integrated") ? comp_mapexplorer_popout : comp_mapexplorer)
