...
EntryContainer {
    ...
    PopupImageFormats {
        ...
        Connections {
            ...
            onEnabledFileformatsChanged:
                formatsPopupEndings.enabledFormats = imageformats.enabledFileformatsDevIL
        }
    ...
    PopupMimeTypes {
        ...
        title: titletext.title
        availableFormats: mimetypes.getAvailableMimeTypesWithDescriptionDevIL()
        enabledFormats: mimetypes.enabledMimeTypesDevIL
        defaultFormats: mimetypes.getDefaultEnabledMimeTypesDevIL()

        Connections {
            target: mimetypes
            onEnabledMimeTypesChanged:
                formatsPopupMimetypes.enabledFormats = mimetypes.enabledMimeTypesDevIL
        }
    ...
    function saveData() {
        imageformats.enabledFileformatsDevIL = formatsPopupEndings.getEnabledFormats()
        mimetypes.enabledMimeTypesDevIL = formatsPopupMimetypes.getEnabledFormats()
    }
