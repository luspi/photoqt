...
Entry {
    ...
    helptext: em.pty+qsTranslate("SettingsManager/ImageFormats", "GraphicsMagick calls itself the 'swiss army knife of image processing'. It\
 supports a wide variety of image formats, and PhotoQt can display the vast majority of them.") +
              "<br><br>" +
