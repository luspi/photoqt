...
PQSetting {
    ...
    content: [
        ...
        PQCheckbox {
            id: mve
            text: em.pty+qsTranslate("settingsmanager_imageview", "Move image with mouse wheel")
        }
    ...
    Connections {
        ...
        onSaveAllSettings: {
            PQSettings.imageviewUseMouseWheelForImageMove = mve.checked
        }
    ...
    function load() {
        mve.checked = PQSettings.imageviewUseMouseWheelForImageMove
    }
