...
EntryContainer {
    ...
    Row {
        ...
        EntryTitle {
            ...
            helptext: entry.enabled
                        ? em.pty+qsTr("These are the file types supported by the Developer's Image Library (DevIL). PhotoQt needs to be compiled with DevIL support in order for PhotoQt to be able to take advantage of them. Not all of these image formats have been tested, as for several no appropriate test images were available.")+"<br><br>" + em.pty+qsTr("Use left click to check/uncheck an individual entry, and right click to check/uncheck all endings related to the same image type.")
        ...
        EntrySetting {
            ...
            Item {
                ...
                GridView {
                    ...
                    property var available: imageformats.getAvailableEndingsWithDescriptionDevIL()
                    ...
                    delegate: FileformatsTile {
                        ...
                        Connections {
                            target: imageformats
                            onEnabledFileformatsDevILChanged:
                                tile.checked = (imageformats.enabledFileformatsDevIL.indexOf(grid.available[index][0])!=-1)
                        }
                ...
                Rectangle {
                    ...
                    CustomButton {
                        ...
                        onClickedButton: imageformats.setDefaultFormatsDevIL()
    ...
    function saveData() {
        imageformats.enabledFileformatsDevIL = entry.checkeditems
    }
