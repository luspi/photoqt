...
EntryContainer {
    ...
    Row {
        ...
        EntryTitle {
            ...
            helptext: entry.enabled
                        ? em.pty+qsTr("PhotoQt can make use of GraphicsMagick for support of many different image formats. These are the file types supported by GraphicsMagick that require GhostScript to be installed.")+"<br><br>" + em.pty+qsTr("Use left click to check/uncheck an individual entry, and right click to check/uncheck all endings related to the same image type.")
        ...
        EntrySetting {
            ...
            Item {
                ...
                GridView {
                    ...
                    property var available: imageformats.getAvailableEndingsWithDescriptionGmGhostscript()
                    ...
                    delegate: FileformatsTile {
                        ...
                        Connections {
                            target: imageformats
                            onEnabledFileformatsGmGhostscriptChanged:
                                tile.checked = (imageformats.enabledFileformatsGmGhostscript.indexOf(grid.available[index][0])!=-1)
                        }
    ...
    function saveData() {
        imageformats.enabledFileformatsGmGhostscript = entry.checkeditems
    }
