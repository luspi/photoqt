...
EntryContainer {
    ...
    Row {
        ...
        EntryTitle {
            ...
            helptext: em.pty+qsTr("These are the file types supported by KDE. If the KDE image formats are installed, they are registered as normal Qt image plugins and can lead the respective image formats rather efficiently.") +
                      "<br><br>" +
        ...
        EntrySetting {
            ...
            Item {
                ...
                GridView {
                    ...
                    property var available: imageformats.getAvailableEndingsWithDescriptionKDE()
                    ...
                    delegate: FileformatsTile {
                        ...
                        Connections {
                            target: imageformats
                            onEnabledFileformatsKDEChanged:
                                tile.checked = (imageformats.enabledFileformatsKDE.indexOf(grid.available[index][0])!=-1)
                        }
                ...
                Rectangle {
                    ...
                    CustomButton {
                        ...
                        onClickedButton: imageformats.setDefaultFormatsKDE()
    ...
    function saveData() {
        imageformats.enabledFileformatsKDE = entry.checkeditems
    }
