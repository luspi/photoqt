...
EntryContainer {
        ...
        EntrySetting {
            ...
            Item {
                ...
                GridView {
                    ...
                    property var available: imageformats.getAvailableEndingsWithDescriptionGm()
                    ...
                    delegate: FileformatsTile {
                        ...
                        Connections {
                            target: imageformats
                            onEnabledFileformatsGmChanged:
                                tile.checked = (imageformats.enabledFileformatsGm.indexOf(grid.available[index][0])!=-1)
                        }
                ...
                Rectangle {
                    ...
                    CustomButton {
                        ...
                        onClickedButton: imageformats.setDefaultFormatsGm()
    ...
    function saveData() {
        imageformats.enabledFileformatsGm = entry.checkeditems
    }
