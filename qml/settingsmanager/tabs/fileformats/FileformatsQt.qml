...
EntryContainer {
    ...
    Row {
        ...
        EntryTitle {
            ...
            helptext: em.pty+qsTr("These file formats are either natively supported by Qt (built-in) or through the image formats plugins (e.g., qt5-imageformats).") +
                      "<br><br>" +
        ...
        EntrySetting {
            ...
            Item {
                ...
                GridView {
                    ...
                    property var available: imageformats.getAvailableEndingsWithDescriptionQt()
                    ...
                    delegate: FileformatsTile {
                        ...
                        Connections {
                            target: imageformats
                            onEnabledFileformatsQtChanged:
                                tile.checked = (imageformats.enabledFileformatsQt.indexOf(grid.available[index][0])!=-1)
                        }
                ...
                Rectangle {
                    ...
                    CustomButton {
                        ...
                        onClickedButton: imageformats.setDefaultFormatsQt()
    ...
    function saveData() {
        imageformats.enabledFileformatsQt = entry.checkeditems
    }
