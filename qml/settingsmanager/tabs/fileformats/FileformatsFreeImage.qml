...
EntryContainer {
    ...
    Row {
        ...
        EntryTitle {
            ...
            id: title
            title: em.pty+qsTr("File Formats") + ":<br>&gt; FreeImage"
            helptext: entry.enabled
                        ? em.pty+qsTr("These are the file types supported by the FreeImage Image Library. PhotoQt needs to be compiled with FreeImage support in order for PhotoQt to be able to take advantage of them. Not all of these image formats have been tested, as for several no appropriate test images were available.")+"<br><br>" + em.pty+qsTr("Use left click to check/uncheck an individual entry, and right click to check/uncheck all endings related to the same image type.")
                        : "<div color='red'>" + em.pty+qsTr("PhotoQt was built without FreeImage support!") + "</div>"
        ...
        EntrySetting {
            ...
            Item {
                ...
                GridView {
                    ...
                    property var available: imageformats.getAvailableEndingsWithDescriptionFreeImage()
                    ...
                    delegate: FileformatsTile {
                        ...
                        Connections {
                            target: imageformats
                            onEnabledFileformatsFreeImageChanged:
                                tile.checked = (imageformats.enabledFileformatsFreeImage.indexOf(grid.available[index][0])!=-1)
                        }
                ...
                Rectangle {
                    ...
                    CustomButton {
                        ...
                        onClickedButton: imageformats.setDefaultFormatsFreeImage()
    ...
    function saveData() {
        imageformats.enabledFileformatsFreeImage = entry.checkeditems
    }
