...
PQFileTypeTile {
    ...
    description: em.pty+qsTranslate("settingsmanager", "PhotoQt can take advantage of xcftools to display Gimp's XCF file format. It can only be enabled if xcftools is installed!")
