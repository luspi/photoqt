...
PQFileTypeTile {
    ...
    description: em.pty+qsTranslate("settingsmanager_filetypes", "FreeImage is an open source image library supporting a number of image formats, many of which have been successfully tested in PhotoQt.")
