function(composeDesktopFile)
    ...
    foreach(version IN LISTS versions)
        ...
        set(MIMETYPE "${MIMETYPE}image/bpg;image/x-canon-crw;image/x-canon-cr2;image/x-win-bitmap;application/dicom;")
        set(MIMETYPE "${MIMETYPE}image/dicom-rle;image/vnd.djvu;image/x-dpx;application/postscript;application/eps;")
        set(MIMETYPE "${MIMETYPE}application/x-eps;image/eps;image/x-eps;image/x-exr;image/fits;")
        set(MIMETYPE "${MIMETYPE}application/vnd.ms-office;image/gif;image/heic;image/heif;image/vnd.microsoft.icon;")
        ...
        set(MIMETYPE "${MIMETYPE}video/x-mng;image/x-mvg;image/openraster;image/x-olympus-orf;image/x-portable-arbitrarymap;")
        set(MIMETYPE "${MIMETYPE}image/x-portable-pixmap;image/x-portable-anymap;image/vnd.zbrush.pcx;image/x-pcx;application/pdf;")
        set(MIMETYPE "${MIMETYPE}application/x-pdf;application/x-bzpdf;application/x-gzpdf;image/x-pentax-pef;image/x-portable-greymap;")
