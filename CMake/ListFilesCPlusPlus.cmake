...
SET(photoqt_SOURCES ${photoqt_SOURCES} ${d}/pqc_scriptsother.cpp ${d}/pqc_scriptsshortcuts.cpp ${d}/pqc_scriptsfilemanagement.cpp)
SET(photoqt_SOURCES ${photoqt_SOURCES} ${d}/pqc_scriptsfiledialog.cpp ${d}/pqc_scriptscontextmenu.cpp)
SET(photoqt_SOURCES ${photoqt_SOURCES} ${d}/pqc_scriptsconfig.cpp ${d}/pqc_scriptsclipboard.cpp)
SET(photoqt_SOURCES ${photoqt_SOURCES} ${d}/pqc_scriptschromecast.cpp)
...
SET(photoqt_SOURCES ${photoqt_SOURCES} ${d}/pqc_scriptsother.h ${d}/pqc_scriptsshortcuts.h ${d}/pqc_scriptsfilemanagement.h)
SET(photoqt_SOURCES ${photoqt_SOURCES} ${d}/pqc_scriptsfiledialog.h ${d}/pqc_scriptscontextmenu.h)
SET(photoqt_SOURCES ${photoqt_SOURCES} ${d}/pqc_scriptsconfig.h ${d}/pqc_scriptsclipboard.h ${d}/pqc_scriptschromecast.h)
...
SET(photoqt_SOURCES ${photoqt_SOURCES} ${d}/pqc_scriptsmetadata_qml.h ${d}/pqc_scriptsfilemanagement_qml.h ${d}/pqc_scriptscontextmenu_qml.h)
SET(photoqt_SOURCES ${photoqt_SOURCES} ${d}/pqc_scriptsother_qml.h ${d}/pqc_scriptsshortcuts_qml.h ${d}/pqc_scriptsfiledialog_qml.h)
SET(photoqt_SOURCES ${photoqt_SOURCES} ${d}/pqc_scriptsconfig_qml.h ${d}/pqc_scriptslocalization_qml.h ${d}/pqc_scriptsclipboard_qml.h)
SET(photoqt_SOURCES ${photoqt_SOURCES} ${d}/pqc_scriptschromecast_qml.h)
