...
// duplicated from PQCScriptsImages
QString PQCScripts::getIconPathFromTheme(QString binary) {
...
QString PQCScripts::loadImageAndConvertToBase64(QString filename) {
...
bool PQCScripts::exportConfigTo(QString path) {
...
bool PQCScripts::importConfigFrom(QString path) {
