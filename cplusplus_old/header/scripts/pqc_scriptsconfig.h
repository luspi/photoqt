...
public:
    ...
    static QString getConfigInfo(bool formatHTML = false);  // duplicated in PQCScripts
    static bool exportConfigTo(QString path);               // duplicated in PQCScripts
    static bool importConfigFrom(QString path);             // duplicated in PQCScripts
