...
#ifndef PQIMAGEFORMATS2_H
#define PQIMAGEFORMATS2_H
...
class PQImageFormats2 : public QObject {

    Q_OBJECT

public:
    static PQImageFormats2& get() {
        static PQImageFormats2 instance;
        return instance;
    }

    PQImageFormats2(PQImageFormats2 const&)     = delete;
    void operator=(PQImageFormats2 const&) = delete;
