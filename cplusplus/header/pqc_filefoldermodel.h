...
public:
    ...
    Q_PROPERTY(bool loadVirtualFolder READ getLoadVirtualFolder WRITE setLoadVirtualFolder NOTIFY loadVirtualFolderChanged)
    bool getLoadVirtualFolder();
    void setLoadVirtualFolder(bool c);
