...
class PQCCScriptsShareImgur : public QObject {
...
public:
    ...
    static PQCCScriptsShareImgur& get() {
        static PQCCScriptsShareImgur instance;
        return instance;
    }
    ~PQCCScriptsShareImgur();

    PQCCScriptsShareImgur(PQCCScriptsShareImgur const&)     = delete;
    void operator=(PQCCScriptsShareImgur const&) = delete;
