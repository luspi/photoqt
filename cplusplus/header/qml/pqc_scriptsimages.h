...
public:
    ...
    // do with image
    QString loadImageAndConvertToBase64(QString filename);   // duplicated in PQCScripts
    ...
    QString getIconPathFromTheme(QString binary);   // duplicated in PQCScripts
...
private:
    ...
    QMap<QString,QStringList> m_archiveContentCache;
    QMap<QString, bool> m_alphaChannels;

    double m_devicePixelRatioCached;
    qint64 m_devicePixelRatioCachedWhen;
