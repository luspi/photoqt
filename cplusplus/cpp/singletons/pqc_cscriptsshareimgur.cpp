...
#include <cpp/pqc_cscriptscrypt.h>
#include <cpp/pqc_httpreplytimeout.h>
...
PQCCScriptsShareImgur::PQCCScriptsShareImgur() {
...
void PQCCScriptsShareImgur::setup() {
...
bool PQCCScriptsShareImgur::checkIfConnectedToInternet() {
...
QString PQCCScriptsShareImgur::authorizeUrlForPin() {
...
int PQCCScriptsShareImgur::authorizeHandlePin(QByteArray pin) {
...
int PQCCScriptsShareImgur::saveAccessRefreshTokenUserName(QString filename) {
    ...
    out << PQCCScriptsCrypt::get().encryptString(txt);
...
int PQCCScriptsShareImgur::obtainClientIdSecret() {
...
int PQCCScriptsShareImgur::forgetAccount() {
...
int PQCCScriptsShareImgur::authAccount() {
    ...
    if(QFile(imgurLocalConfigFilename).exists()) {
        ...
        QString cont = "";
        QTextStream in(&file);
        cont = PQCCScriptsCrypt::get().decryptString(in.readAll());
...
int PQCCScriptsShareImgur::upload(QString filename) {
    ...
    connect(reply, &QNetworkReply::finished, this, &PQCCScriptsShareImgur::uploadFinished);
    connect(reply, &QNetworkReply::uploadProgress, this, &PQCCScriptsShareImgur::uploadProgress);
    ...
    connect(reply, &QNetworkReply::errorOccurred, this, &PQCCScriptsShareImgur::uploadError);
    connect(this, &PQCCScriptsShareImgur::abortAllRequests, reply, &QNetworkReply::abort);
...
int PQCCScriptsShareImgur::anonymousUpload(QString filename) {
...
int PQCCScriptsShareImgur::deleteImage(QString hash) {
...
void PQCCScriptsShareImgur::uploadProgress(qint64 bytesSent, qint64 bytesTotal) {
...
// An error occurred
void PQCCScriptsShareImgur::uploadError(QNetworkReply::NetworkError err) {
...
void PQCCScriptsShareImgur::uploadFinished() {
...
QString PQCCScriptsShareImgur::getAuthDateTime() {
...
void PQCCScriptsShareImgur::abort() {
    ...
    Q_EMIT abortAllRequests();
    QTimer::singleShot(500, this, &PQCCScriptsShareImgur::abortAllRequests);

}

void PQCCScriptsShareImgur::storeNewUpload(QString filename, QString imageUrl, QString deleteHash) {
...
QVariantList PQCCScriptsShareImgur::getPastUploads() {
...
QImage PQCCScriptsShareImgur::getPastUploadThumbnail(QString timestamp) {
...
bool PQCCScriptsShareImgur::deletePastEntry(QString timestamp) {
...
void PQCCScriptsShareImgur::closeDatabase() {
