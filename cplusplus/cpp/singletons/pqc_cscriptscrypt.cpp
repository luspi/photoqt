...
PQCCScriptsCrypt &PQCCScriptsCrypt::get() {
    static PQCCScriptsCrypt instance;
    return instance;
}

PQCCScriptsCrypt::PQCCScriptsCrypt() {
...
QString PQCCScriptsCrypt::encryptString(QString plaintext) {
...
QString PQCCScriptsCrypt::decryptString(QString str) {
