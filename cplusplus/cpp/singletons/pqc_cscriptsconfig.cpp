...
PQCCScriptsConfig::PQCCScriptsConfig() {

}

QString PQCCScriptsConfig::getConfigInfo(bool formatHTML) {
...
bool PQCCScriptsConfig::exportConfigTo(QString path) {
...
bool PQCCScriptsConfig::importConfigFrom(QString path) {
