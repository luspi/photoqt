...
PQTemplatePopout {
    ...
    isMax: false
    popout: PQCSettings.extensionsQuickActionsPopout || (sizepopout && PQCSettings.interfacePopoutWhenWindowIsSmall)
    ...
    onPopoutClosed: {
        PQCSettings.extensionsQuickActionsPopout = false
        close()
    ...
    onPopoutChanged: {
        if(popout !== PQCSettings.extensionsQuickActionsPopout)
